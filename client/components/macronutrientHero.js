...
export default function MacronutrientHero() {
    const [ counter, setCounter ] = useState(0);


    return (
        <div className="bg-white min-h-screen">
        <div className="mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:px-20">
          <div className="overflow-hidden rounded-lg bg-amber-400 shadow-xl lg:grid lg:grid-cols-2 lg:gap-4" style={{
            ...
            {counter === 0? (<><div className="px-6 pt-10 pb-12 sm:px-16 sm:pt-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
                    ...
                    </div><div className="aspect-w-5 aspect-h-3 -mt-6 pb-6 md:pb-0  md:aspect-w-2 md:pr-6 md:aspect-h-1">
                            <img
                        ...
                        : 
            counter === 1? (<><div className="px-6 pt-10 pb-12 sm:px-16 sm:pt-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
            <div className="lg:self-center">
                <h2 className="text-3xl font-bold tracking-tight text-gray-50 sm:text-4xl">
                    <span className="block text-white">Carbs.</span>
                    <span className="block">The first macronutrient we'll cover</span>
                </h2>
                <p className="mt-4 text-lg leading-6 text-gray-200">
        ...
        </div><div className="aspect-w-5 aspect-h-3 -mt-6 pb-6 md:pb-10  md:aspect-w-2 md:pr-6 md:aspect-h-1">
                <img
                    className="translate-x-6 translate-y-6 transform rounded-md object-cover object-left-top sm:translate-x-16 lg:translate-y-20"
            ...
            : 
            counter === 2? (<><div className="px-6 pt-10 pb-12 sm:px-16 sm:pt-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
            <div className="lg:self-center">
                <h2 className="text-3xl font-bold tracking-tight text-gray-50 sm:text-4xl">
                    <span className="block text-white">Proteins.</span>
                    <span className="block">The building blocks of muscles</span>
                </h2>
                <p className="mt-4 text-lg leading-6 text-gray-200">
                Protein is essential to many processes in the body. It provides structure to the tissue. 
                That includes cell membranes, organs, muscle, hair, skin, nails, bones, tendons, ligaments and blood plasma.
                </p>
                <button
            ...
            counter === 3? (<><div className="px-6 pt-10 pb-12 sm:px-16 sm:pt-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
            <div className="lg:self-center">
                <h2 className="text-3xl font-bold tracking-tight text-gray-50 sm:text-4xl">
