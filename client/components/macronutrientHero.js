  ...
  return (
    <><div className="bg-white min-h-screen">
          <div className="flex  mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:px-20">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-24 h-24 lg:w-16 lg:h-16 my-44 mx-1.5 sm:mx-4 fill-gray-300 hover:fill-gray-600" onClick={() => handleClick2()}>
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-0 lg:pt-20">
            <div className="mx-auto max-w-7xl">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-24 h-24 lg:w-16 lg:h-16 my-44 mx-1.5 sm:mx-4 fill-gray-300 hover:fill-gray-600" onClick={() => handleClick1()}>
