...
export default function Recipes() {
  ...
  return (
    <>
      ...
      >
        <h1 className="pt-6 lg:pt-12 text-center text-4xl xl:text-5xl text-white font-semibold"> Chicken</h1>
        <div className="flex max-w-7xl mx-auto justify-center my-8 overflow-hidden">
        ...
        <h1 className="pt-6 lg:pt-12 text-center text-4xl xl:text-5xl text-white font-semibold"> Seafood</h1>
        <div className="flex max-w-7xl mx-auto justify-center my-8 overflow-hidden">
          <ul
            role="list"
            className="grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-3 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8 overflow-x-auto"
        ...
        <h1 className="pt-6 lg:pt-12 text-center text-4xl xl:text-5xl text-white font-semibold"> Meat </h1>
        <div className="flex max-w-7xl mx-auto justify-center my-8 overflow-hidden">
          <ul
            role="list"
            className="grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-3 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8 overflow-x-auto"
        ...
        <h1 className="pt-6 lg:pt-12 text-center text-4xl xl:text-5xl text-white font-semibold"> Vegetarian</h1>
        <div className="flex max-w-7xl mx-auto justify-center my-8 pb-4 overflow-hidden">
          <ul
            role="list"
            className="grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-3 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8 overflow-x-auto"
          >
