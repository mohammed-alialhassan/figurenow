...
export default function CommunityGuidelines() {
    ...
    const community = [
        {guideline: "Treat others with dignity, compassion and respect"},
        {guideline: "No Trolling"},
        {guideline: "Keep your images Workplace Friendly"},
        {guideline: "Keep your language Workplace Friendly (no swearing, slurs, etc.)"},
        {guideline: "We WILL NOT tolerate the promotion of Unsafe Weight-Loss Techniques or Eating Disorders"},
        {guideline: "We WILL NOT tolerate the distribution of ANYONE's private information"},
        {guideline: "Keep it legal"},
        {guideline: "Have fun!"}
    ];
  return (
    <>
