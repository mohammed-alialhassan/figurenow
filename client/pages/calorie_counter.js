  ...
  return (
    <>
      ...
      <main>
        ...
        >
        {counter === 1? (<Step1 setGender={setGender} />) : counter === 2? (<Step2 setAge={setAge} />) : counter === 3? (<Step3 setWeight={setWeight} settingHeight={settingHeight} />) : counter === 4? (<Step4 settingActiveRate={settingActiveRate} />) : counter === 5? (<Step5 settingGoal={settingGoal} />) : counter === 6 && loading? (<div> HELLO </div>) : (<div></div>)}
