  ...
  return (
    <>
      ...
      <main className="min-w-max">
        ...
        >
          {counter === 1 ? (
            <Step1 setGender={setGender} />
          ) : counter === 2 ? (
            <Step2 setAge={setAge} />
          ) : counter === 3 ? (
            <Step3 setWeight={setWeight} settingHeight={settingHeight} />
          ) : counter === 4 ? (
            <Step4 settingActiveRate={settingActiveRate} />
          ) : counter === 5 ? (
            <Step5 settingGoal={settingGoal} />
          ) : counter === 6 && loading ? (
            <Loading
              info={info}
              age={age}
          ...
          <div className="flex justify-center">
            <div className="flex gap-x-3 justify-center lg:gap-x-0.5 w-8/12 lg:w-4/12 rounded bg-inherit">
              ...
              ) : (counter === 6) & !loading ? null : (counter === 3) &
