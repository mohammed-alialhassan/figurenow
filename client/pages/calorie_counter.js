  ...
  return (
    <>
      ...
      <main>
        ...
        >
        {counter === 1? (<Step1 setGender={setGender} />) : counter === 2? (<Step2 setAge={setAge} />) : counter === 3? (<Step3 setWeight={setWeight} />) : counter === 4? (<Step4 />) : (<div></div>)}
