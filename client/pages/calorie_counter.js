...
export default function CalorieCounter() {
  ...
  console.log(info, age, weight, height, activeRate)
  ...
  return (
    <>
      ...
      <main>
        ...
        >
        {counter === 1? (<Step1 setGender={setGender} />) : counter === 2? (<Step2 setAge={setAge} />) : counter === 3? (<Step3 setWeight={setWeight} settingHeight={settingHeight} />) : counter === 4? (<Step4 settingActiveRate={settingActiveRate} />) : counter === 5? (<Step5 />) : (<div></div>)}
